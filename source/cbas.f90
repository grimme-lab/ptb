...
! Clementi's SZ Slater exponents from JCP 38 (1963), 2686 ibid 47 (1967), 1300.
      ...
      cslexpo(1, 57)=55.8683
      cslexpo(2, 57)=20.9767
      cslexpo(3, 57)=26.3978
      cslexpo(4, 57)=12.6477
      cslexpo(5, 57)=12.7132
      cslexpo(6, 57)=14.3534
      cslexpo(7, 57)= 7.1991
      cslexpo(8, 57)= 6.9266
      cslexpo(9, 57)= 6.1813
...
!     near HF levels
      ...
      clev(10,56)=    -1.510172
      clev(11,56)=    -0.900567
      clev(1, 57)= -1372.280316 
      clev(2, 57)=  -216.277016
      clev(3, 57)=  -203.907421
      clev(4, 57)=   -47.844418
      clev(5, 57)=   -42.459156
      clev(6, 57)=   -32.553605
      clev(7, 57)=   -10.345538     
