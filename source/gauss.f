      SUBROUTINE SETSTO4(n,l,zeta,expo,cont)
      ...
      if(n.gt.5.or.l.gt.3) stop 'error in setsto4'
      nprim=4
...
c     ALLZ(1,4,4) =0.05691670217
c     ALLZ(2,4,4) =0.2074585819  
c     ALLZ(3,4,4) =0.09298346885 
c     ALLZ(4,4,4) =0.04473508853 
c     ALLC(1,4,4) =0.05902730589/1.063832358490576**0.5
c     ALLC(2,4,4) =0.3191828952 /1.063832358490576**0.5
c     ALLC(3,4,4) =0.5639423893 /1.063832358490576**0.5
c     ALLC(4,4,4) =0.2284796537 /1.063832358490576**0.5
     ...
     .          SQRT(DEX(2*IAM-1))
      ...
      SUBROUTINE SETSTO6(n,l,zeta,expo,cont)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      dimension expo(*),cont(*)
      ...
      if(n.gt.6.or.l.gt.3) stop 'error in setsto6'
      nprim=6
